...
/*
 * TRIÈDRE — Diagnostic Postes Canada LIVE / POST /prices — V3
 *
 ...
 */
if (!preg_match('/^[ABCEGHJKLMNPRSTVXY][0-9][ABCEGHJKLMNPRSTVWXYZ][0-9][ABCEGHJKLMNPRSTVWXYZ][0-9]$/', $originPostal)) {
    sortie([
        'ok' => false,
        'etape' => 'configuration',
